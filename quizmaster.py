...
def draw():
    ...
    screen.draw.filled_rect(question_box,"darkblue")
    screen.draw.filled_rect(time_box,"red")
    screen.draw.filled_rect(answer_box1,"darkblue")
    screen.draw.filled_rect(answer_box2,"red")
    screen.draw.filled_rect(answer_box3,"drawblue")
    screen.draw.filled_rect(answer_box4,"red")
    screen.draw.filled_rect(skip_box,"darkblue")
